...
import it.citylife.model.save.SaveLoadManager.BuildingEntry;
import it.citylife.model.save.SaveLoadManager.SaveData;
...
final class SaveDataMapper {
    ...
    private static BuildingEntry toEntry(Structure st, int x, int y) {
        ...
        if (st instanceof StructureDecorator dec) {
            ...
            Structure base = st;
            while (base instanceof StructureDecorator dd) base = dd.getWrapped();
